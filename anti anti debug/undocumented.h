...
namespace  Offsets
{
    DWORD    processDebugPort = 0x578;
    DWORD    psSuspendThreadOffset = 0x70C4F0;
    DWORD    processLinksOffset = 0x448;
    DWORD    PEBoffset = 0x550;
    DWORD    PsResumeThreadOffset = 0x5E8320;
}